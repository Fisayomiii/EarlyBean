            ...
            <main style={{ backgroundImage: "url(https://res.cloudinary.com/dn6fnuhxr/image/upload/v1636863926/3d-background.png)" }}><br />
                <header className="container flex flex-col sm:flex-row py-20 mx-auto max-w-screen-lg items-center">
                    <div className="w-full sm:w-2/3 px-6 py-8 " >
                        <h1 className="text-4xl mb-4 lg:text-6xl leading-tight xl:leading-tight text-bean-purple-900 font-bold animate__animated animate__fadeInLeft animate__delay-1s">
                            <span className="relative inline-block animate__animated animate__flash animate__delay-4s">
                        ...
                        <p className="max-w-full sm:max-w-md leading-8 animate__animated animate__fadeInLeft animate__delay-2s">Savings, earnings, investment and allowance app for kids and teens in Nigeria.</p>
                        <button type="button" className="mt-5 text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 hover:shadow-lg shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 animate__animated animate__fadeInLeft animate__delay-3s">Get early Access</button>
                        <Getiton/>
                    </div>
                    <div className="self-start md:justify-self-end animate__animated animate__fadeIn animate__delay-2s">
