function Footer() {
    return (
        <>
            <div style={{ backgroundColor: "#F6D8FF" }}>
                <footer className="p-4 mt-11 bg-white sm:p-6 dark:bg-gray-800" >
                    <div className="mx-auto max-w-screen-xl" >
                            ...
                            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                                <div data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
                                    ...
                                    <ul className="text-gray-600 dark:text-gray-400">
                                        <li className="mb-4">
                                            <a href="/" className="hover:underline">EarlyBean</a>
                                        </li>
                                        <li>
                        ...
                        <div className="sm:flex sm:items-center sm:justify-between">
                            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://EarlyBean.com" className="hover:underline">EarlyBean™</a>. All Rights Reserved.
                            </span>
